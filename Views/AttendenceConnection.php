...
if(isset($_SESSION['id'])){
    ...
    if (isset($_POST['submit'])) {
        $sql1 = "SELECT First_Name, Last_Name,M_id, Username FROM users_data WHERE E_id='$id'";
        ...
        if ($results->num_rows > 0) {
            ...
            $StartingT=$_POST["StartingT"];
            $EndingT=$_POST["EndingT"];
            $Reason = $_POST["reason"];
            $Remark=$_POST["Remark"];
            ...
            $sql = "INSERT INTO AtRequest (E_id,M_id,Name,Date,IDate,Punch_in,ODate,Pinch_out,Reason,Remark,Status)
                VALUES ('$id','$Mid','$name','$Atdate','$StartingD','$StartingT','$EndingD','$EndingT','$Reason','$Remark',' ')";
...
<body style="background: #f1f1f1;">
    <div class="p-3 mb-2 bg-white text-dark">
        <h3>REGULARIZATION APPLICATION FORM</h3>
        <h6>Request Flow</h6>

        <br>
        <form class="row g-3 needs-validation" method="POST">
            <div class="row g-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Attendance Date</label>
                <div class="col-sm-2">
                    <input type="date" class="form-control" name="Atdate" id="inputEmail3" style="border-left: 2px solid #bb0000;"
                        required>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="reason" type="radio" name="exampleRadios" id="exampleRadios1"
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="reason" type="radio" name="exampleRadios" id="exampleRadios2"
                        value="Forgot Check-out">
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="reason" type="radio" name="exampleRadios" id="exampleRadios3"
                        value="Both" >
            ...
            <div class="row g-3">
                <label for="validationCustom01" class="col-sm-2 col-form-label">In Punch</label>
                <div class="col-md-4">
                    <!--<label for="validationCustom01" class="col-sm-4 col-form-label">In Punch</label>-->
                    <p><input type="date" id="fromDate" name="StartingD" style="border-right: 1px solid #e5e6e7;
    border-top: 1px solid #e5e6e7;
    border-bottom: 1px solid #e5e6e7;
    border-left: 2px solid #bb0000" required><input type="time" name="StartingT" style="border-right: 1px solid #e5e6e7;
    border-top: 1px solid #e5e6e7;
    border-bottom: 1px solid #e5e6e7;
    border-left: 2px solid #bb0000" required></p>
                ...
                <div class="col-md-4">
                    <!--<label for="validationCustom01" class="col-sm-4 col-form-label">In Punch</label>-->
                    <p>Out Punch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" id="toDate"
                            name="EndingD" style="border-right: 1px solid #e5e6e7;
    border-top: 1px solid #e5e6e7;
    border-bottom: 1px solid #e5e6e7;
    border-left: 2px solid #bb0000" required><input type="time" name="EndingT" style="border-right: 1px solid #e5e6e7;
    border-top: 1px solid #e5e6e7;
    border-bottom: 1px solid #e5e6e7;
    border-left: 2px solid #bb0000" required></p>
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    ...
                    <textarea class="form-control mdt_feild required" cols="20" id="txtReason" maxlength="200"
                        name="Remark" placeholder="Reason (max 200 characters)" rows="2"
