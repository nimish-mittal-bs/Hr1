...
<p>&nbsp;&nbsp;&nbsp;Self Service/&nbsp;Approvel/&nbsp;Leave</p>
...
//echo "hi";
 ...
 //echo "hi";
   ...
   //$name=$row["First_Name"]." ".$row["Last_Name"];
   //$Satatus="Approved";
    $result = mysqli_query($conn,"SELECT * FROM LeaveTable WHERE E_id='$Eid' LIMIT $start_from, $limit");
...
?><?php echo $row["Lid"]; ?>
            <tr>
            <td><input class="select-item" type="checkbox" id="<?php echo $row["Lid"]; ?>"></td>
...
if ($result=mysqli_query($conn,$sql1))
{
  // Return the number of rows in result set
      ...
      for($b=1;$b<=$a;$b++)
      {
        $pagLink .= "<li class='page-item'><a class='page-link' href='admin_Leave1.php?page=".$b."'>".$b."</a></li>";
