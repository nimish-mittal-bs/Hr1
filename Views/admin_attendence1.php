...
if(isset($_SESSION['id'])){
  ...
  require 'database.php';
   ...
   $Satatus="Approved"  ;
//    if((isset($_POST['button1']) or (isset($_POST['button2'])))){
// echo "1234";
//    if(!empty($_POST['checkqn'])) {

//     foreach($_POST['checkqn'] as $value){
//         echo "value : ".$value.'<br/>';
//     }
...
?>
            <tr>
                <td><input class="select-item" type="checkbox" id="<?php echo $row["Aid"]; ?>"></td>
...
if ($result=mysqli_query($conn,$sql1))
{
  // Return the number of rows in result set
      ...
      for($b=1;$b<=$a;$b++)
      {
        $pagLink .= "<li class='page-item'><a class='page-link' href='admin_attendence1.php?page=".$b."'>".$b."</a></li>";
